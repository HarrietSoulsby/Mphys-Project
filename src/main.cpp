...
int main(){
	...
	double beam_intensity_night, beam_intensity_day, integrated_turbulence_night, integrated_turbulence_day, satellite_distance, diffraction_transmissivity_day, diffraction_transmissivity_night, extinction_transmissivity, total_transmissivity_day, total_transmissivity_night;
	...
	#pragma omp parallel for private(angle, angle_degrees, beam_intensity_night, beam_intensity_day, integrated_turbulence_night, integrated_turbulence_day, satellite_distance, diffraction_transmissivity_day, diffraction_transmissivity_night, extinction_transmissivity, total_transmissivity_day, total_transmissivity_night)
	for(int i = 0; i <= iterations; ++i){
		...
		total_transmissivity_night = beam_intensity_night*diffraction_transmissivity_night*extinction_transmissivity;
		total_transmissivity_day = beam_intensity_day*diffraction_transmissivity_day*extinction_transmissivity;
